            ...
            { saveStatus === "saved" &&
                ...
                <div className="flex gap-4 flex-col justify-center items-center mb-12 md:mb-0">
                    <div className="flex justify-center items-center">
                        ...
                        <EmailShareButton url="https://bracket.iprevailband.com" subject="I Prevail - Bracket-ology" body="I just submitted my #iprevailbracket!">
...
const CountdownTimer = () => {
    const calculateTimeLeft = () => {
        ...
        const longOffsetString = longOffsetFormatter.format(new Date("2024-04-01T23:59:59"))
        const gmtOffset = longOffsetString.split('GMT')[1]
        const d = new Date("2024-04-01T23:59:59" + gmtOffset)

        let year = new Date().getFullYear()
        // let difference = +new Date(`2024-03-25T23:59:59 EST`) - +new Date()
        let difference = +new Date(d.toISOString()) - +new Date()
